...
## Exercise 1.1 - Launch the Migration Assessment page
...
## Browse through the Scenario Evaluation
...
Scoll down a bit. This shows you the statistics of the modernization recommendations. Instead of pure lift and shift, alternative implementation options are recommended in terms of integration styles, protocols, and security.
